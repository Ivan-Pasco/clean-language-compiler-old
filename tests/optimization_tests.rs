...
fn test_dead_code_elimination() {
    ...
    let original_block_count = mir_program.functions.get("test_function")
        .unwrap().basic_blocks.len();
    
    // Run dead code elimination
    let eliminated_count = eliminate_dead_code(&mut mir_program)
    ...
    let final_block_count = mir_program.functions.get("test_function")
        .unwrap().basic_blocks.len();
...
fn create_test_program_with_dead_code() -> MIRProgram {
    ...
    functions.insert("test_function".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            ...
            MIRBasicBlock {
                id: 1,
                instructions: vec![
                    MIRInstruction::Const(1, MIRConstant::Integer(999)),
                ],
...
fn test_constant_folding() {
    ...
    let folded_count = fold_constants(&mut mir_program)
...
fn create_test_program_with_constants() -> MIRProgram {
    ...
    functions.insert("constant_test".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            MIRBasicBlock {
                ...
                instructions: vec![
                    ...
                    MIRInstruction::Add(0, MIROperand::Constant(MIRConstant::Integer(5)), MIROperand::Constant(MIRConstant::Integer(10))),
                    MIRInstruction::Mul(1, MIROperand::Constant(MIRConstant::Integer(3)), MIROperand::Constant(MIRConstant::Integer(4))),
...
fn test_function_inlining() {
    ...
    let inlined_count = inline_functions(&mut mir_program, 5)
...
fn create_test_program_with_inlinable_functions() -> MIRProgram {
    ...
    functions.insert("small_function".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            MIRBasicBlock {
                id: 0,
                instructions: vec![
                    MIRInstruction::Const(0, MIRConstant::Integer(100)),
                ],
                terminator: MIRTerminator::Return(Some(MIROperand::Local(0))),
            }
        ],
    ...
    functions.insert("main".to_string(), MIRFunction {
        name: "main".to_string(),
        parameters: vec![],
        return_type: MIRType::I32,
        locals: vec![],
...
fn test_control_flow_optimization() {
    ...
    let optimized_count = optimize_control_flow(&mut mir_program)
        .expect("Control flow optimization should succeed");
    ...
    println!("Block count: {} -> {}", original_block_count, final_block_count);
...
fn create_test_program_with_control_flow_issues() -> MIRProgram {
    ...
    functions.insert("control_test".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            ...
            MIRBasicBlock {
                id: 2,
                instructions: vec![
                    MIRInstruction::Const(1, MIRConstant::Integer(0)),
                ],
                terminator: MIRTerminator::Return(Some(MIROperand::Local(1))),
            },
...
fn create_comprehensive_test_program() -> MIRProgram {
    ...
    functions.insert("comprehensive_test".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            MIRBasicBlock {
                ...
                instructions: vec![
                    ...
                    MIRInstruction::Add(1, MIROperand::Constant(MIRConstant::Integer(10)), MIROperand::Constant(MIRConstant::Integer(20))),
                    MIRInstruction::Mul(2, MIROperand::Constant(MIRConstant::Integer(2)), MIROperand::Constant(MIRConstant::Integer(3))),
                    // Dead store (immediately overwritten)
                    MIRInstruction::Add(1, MIROperand::Local(1), MIROperand::Local(2)),
                    MIRInstruction::Add(1, MIROperand::Local(0), MIROperand::Constant(MIRConstant::Integer(1))),
                ],
                // Constant branch that can be simplified
                terminator: MIRTerminator::Branch {
                    condition: MIROperand::Constant(MIRConstant::Boolean(true)),
            ...
            MIRBasicBlock {
                id: 1,
                instructions: vec![
                    MIRInstruction::Add(2, MIROperand::Local(1), MIROperand::Constant(MIRConstant::Integer(5))),
                ],
                terminator: MIRTerminator::Return(Some(MIROperand::Local(2))),
            },
            // Unreachable block (dead code)
            MIRBasicBlock {
                id: 2,
                instructions: vec![
                    MIRInstruction::Const(2, MIRConstant::Integer(999)),
                ],
                terminator: MIRTerminator::Return(Some(MIROperand::Local(2))),
            },
        ],
...
fn test_optimization_levels() {
    ...
    for opt_level in test_cases {
        ...
        let stats = optimize_mir_program(&mut mir_program, opt_level)
        ...
        println!("✅ {:?} optimization level: {} total optimizations", opt_level, stats.total_optimizations());
    }
...
fn test_algebraic_simplification() {
    ...
    functions.insert("algebra_test".to_string(), MIRFunction {
        ...
        basic_blocks: vec![
            MIRBasicBlock {
                ...
                instructions: vec![
                    ...
                    MIRInstruction::Add(1, MIROperand::Local(0), MIROperand::Constant(MIRConstant::Integer(0))),
                    // x * 1 should be optimized
                    MIRInstruction::Mul(2, MIROperand::Local(1), MIROperand::Constant(MIRConstant::Integer(1))),
                    // x * 0 should become 0
                    MIRInstruction::Mul(3, MIROperand::Local(2), MIROperand::Constant(MIRConstant::Integer(0))),
                ],
    ...
    assert!(folded_count > 0, "Should have applied some algebraic optimizations");
