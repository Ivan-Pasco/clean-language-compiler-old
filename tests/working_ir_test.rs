...
fn test_comprehensive_ir_summary() {
    ...
    println!(
        "   ✓ MIR: Operands and constants work (tested {} operands)",
        mir_operands.len()
    );
    ...
    println!(
        "   ✓ MIR: Instructions and arithmetic work (tested {} instructions)",
        mir_instructions.len()
    );
    ...
    println!(
        "   ✓ LIR: WebAssembly instructions work (tested {} instructions)",
        lir_instructions.len()
    );
    ...
    println!(
        "   ✓ Optimization: {}/4 optimization passes work",
    ...
    println!(
        "   ✓ Validation: {}/3 validation passes work",
        working_validations
    );
    ...
    println!(
        "   ✅ Optimization Framework: {} passes ready",
        working_optimizations
    );
    println!(
        "   ✅ Validation Framework: {} validators ready",
        working_validations
    );
    println!();
