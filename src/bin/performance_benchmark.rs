...
fn print_benchmark_report(results: &[BenchmarkResult]) {
    ...
    println!("Average parse time: {:.2}ms", total_parse_time.as_secs_f64() * 1000.0 / total_files as f64);
    println!("Average semantic time: {:.2}ms", total_semantic_time.as_secs_f64() * 1000.0 / total_files as f64);
    println!("Average total time: {:.2}ms", total_compilation_time.as_secs_f64() * 1000.0 / total_files as f64);
    ...
    if successful_files == total_files {
        ...
        println!("❌ {}/{} benchmarks failed", total_files - successful_files, total_files);
    }
}
