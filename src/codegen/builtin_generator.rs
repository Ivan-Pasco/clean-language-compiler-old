...
impl CodeGenerator {
    ...
    fn register_conditional_operations(&mut self) -> Result<(), CompilerError> {
        // Method body removed - conditional, comparison, and logical operations
        // are now implemented using native WASM operators directly in the codegen,
        // not through registered functions.
        Ok(())
    }
