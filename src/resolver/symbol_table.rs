...
impl GlobalSymbolTable {
    ...
    fn add_builtin_namespace_identifiers(&mut self, global_scope: ScopeId) {
        ...
        let math_functions = vec![
            ...
            self.lookup_symbol("math.add").unwrap_or(SymbolId(0)),
            self.lookup_symbol("math.subtract").unwrap_or(SymbolId(0)),
            self.lookup_symbol("math.multiply").unwrap_or(SymbolId(0)),
            self.lookup_symbol("math.divide").unwrap_or(SymbolId(0)),
        ];
