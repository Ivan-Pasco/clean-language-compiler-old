...
impl AsyncProgrammingManager {
    ...
    fn register_future_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32], // task_function_ptr
            Some(WasmType::I32), // future pointer
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // future_ptr, task_id, scheduler_ptr, status, start_time
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // status, result_ptr, wait_cycles, timeout, is_ready
    ...
    fn register_async_execution_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            Some(WasmType::I32), // future pointer
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // future_ptr, task_id, status, context_ptr, args_len
    ...
    fn register_background_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_sync_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // array_len, results_ptr, completed_count, current_future, current_result, i
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // array_len, current_future, status, result_ptr, i
    ...
    fn generate_create_future(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // load task counter
    ...
    fn generate_start_task(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // active task count
            Instruction::I32Const(4),
            Instruction::I32Mul,
            ...
            Instruction::LocalGet(2), // scheduler_ptr
            Instruction::LocalGet(2), // scheduler_ptr
            Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // current count
            Instruction::I32Const(1),
            Instruction::I32Add,
            Instruction::I32Store(MemArg { offset: 4, align: 2, memory_index: 0 }),
            ...
            Instruction::LocalGet(0), // future_ptr
            Instruction::I32Store(MemArg { offset: 12, align: 2, memory_index: 0 }), // Store result pointer
    ...
    fn generate_background_task(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // background task count
            ...
            Instruction::LocalGet(1), // scheduler_ptr
            Instruction::LocalGet(1), // scheduler_ptr
            Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // current count
            Instruction::I32Const(1),
            Instruction::I32Add,
            Instruction::I32Store(MemArg { offset: 8, align: 2, memory_index: 0 }),
    ...
    fn generate_execute_async(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Store(MemArg { offset: 28, align: 2, memory_index: 0 }),
    ...
    fn generate_mark_background(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::LocalGet(1), // background_registry_ptr
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // current count
            Instruction::I32Const(4),
            Instruction::I32Mul,
            Instruction::I32Add,
    ...
    fn generate_wait_any(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::If(wasm_encoder::BlockType::Empty),
                ...
                Instruction::I32Load(MemArg { offset: 12, align: 2, memory_index: 0 }), // result_ptr
                Instruction::LocalSet(3), // result_ptr
            Instruction::End,
    ...
    fn generate_timeout(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::LocalGet(0), // future_ptr
            Instruction::I32Load(MemArg { offset: 20, align: 2, memory_index: 0 }),
    ...
    fn generate_sleep(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Store(MemArg { offset: 24, align: 2, memory_index: 0 }),
    ...
    fn generate_yield_control(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::LocalGet(0), // scheduler_ptr
            Instruction::I32Load(MemArg { offset: 12, align: 2, memory_index: 0 }), // yield count
            Instruction::I32Const(1),
            Instruction::I32Add,
            Instruction::I32Store(MemArg { offset: 12, align: 2, memory_index: 0 }),
    ...
    fn generate_get_current_task(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Const(0x9000), // scheduler base
            Instruction::I32Load(MemArg { offset: 16, align: 2, memory_index: 0 }), // current_task_id
            Instruction::LocalSet(0), // task_id
