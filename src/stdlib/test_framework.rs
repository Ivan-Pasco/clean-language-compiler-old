...
impl TestFrameworkManager {
    ...
    fn register_test_execution_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_test_reporting_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        // Report test pass
        register_stdlib_function_with_locals(
            codegen,
            "test.reportPass",
    ...
    fn register_test_runner_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn get_current_time_function_index(&self) -> u32 { 800 }
    fn get_clear_error_function_index(&self) -> u32 { 801 }
    fn get_has_error_function_index(&self) -> u32 { 802 }
    fn get_error_message_function_index(&self) -> u32 { 803 }
    fn get_report_pass_function_index(&self) -> u32 { 804 }
    fn get_report_fail_function_index(&self) -> u32 { 805 }
    fn get_print_suite_start_function_index(&self) -> u32 { 806 }
    fn get_create_report_function_index(&self) -> u32 { 807 }
    fn get_print_summary_function_index(&self) -> u32 { 808 }
    fn get_run_test_list_function_index(&self) -> u32 { 809 }
    fn get_throw_test_error_function_index(&self) -> u32 { 810 }
    fn get_allocate_function_index(&self) -> u32 { 811 }
    fn get_print_test_pass_function_index(&self) -> u32 { 812 }
    fn get_print_test_fail_function_index(&self) -> u32 { 813 }
    fn get_print_test_summary_function_index(&self) -> u32 { 814 }
    fn get_init_test_environment_function_index(&self) -> u32 { 815 }
    fn get_cleanup_test_environment_function_index(&self) -> u32 { 816 }
    fn get_create_mock_function_index(&self) -> u32 { 817 }
    
    fn get_test_passed_address(&self) -> i32 { 0x3000 }
    fn get_test_failed_address(&self) -> i32 { 0x3004 }
    fn get_test_total_address(&self) -> i32 { 0x3008 }
}
...
mod tests {
    ...
    fn test_suite_management() {
        ...
        assert!(matches!(run_suite[run_suite.len() - 1], Instruction::I32Eqz));
    }
