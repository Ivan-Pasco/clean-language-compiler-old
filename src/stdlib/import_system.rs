...
impl ImportSystemManager {
    ...
    fn register_import_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // module_len, symbol_len, symbol_table_ptr, symbol_id, result
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // module_len, symbol_len, alias_len, symbol_table_ptr, symbol_id, result
    ...
    fn register_resolution_functions(
        &self,
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // path_len, file_content_ptr, parse_result, module_id, result
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // module_len, symbol_len, module_exists, symbol_exists, result
    ...
    fn register_utility_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // name_len, info_table_ptr, found_entry, info_ptr, result
