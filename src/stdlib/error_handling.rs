...
impl ErrorHandlingManager {
    ...
    fn register_error_expression_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_error_handling_blocks(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_error_propagation_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn get_has_error_function_index(&self) -> u32 { 600 }
    fn get_clear_error_function_index(&self) -> u32 { 601 }
    fn get_execute_block_function_index(&self) -> u32 { 602 }
    fn get_allocate_function_index(&self) -> u32 { 603 }
    fn get_set_error_state_function_index(&self) -> u32 { 604 }
    
    fn get_error_state_address(&self) -> i32 { 0x1000 }
    fn get_error_message_address(&self) -> i32 { 0x1004 }
    fn get_error_flag_address(&self) -> i32 { 0x1008 }
}
