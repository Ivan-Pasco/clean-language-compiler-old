...
use wasm_encoder::{Instruction, MemArg, BlockType};
use std::rc::Rc;
...
impl FileAdvancedManager {
    ...
    fn register_advanced_read_operations(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // content_ptr, content_len, lines_array, line_count, i, current_line_start
    ...
    fn register_advanced_info_operations(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_path_operations(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // path_len, i, last_slash, filename_start, filename_len
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // path_len, i, last_dot, extension_start, extension_len
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // path1_len, path2_len, result_ptr, needs_separator, total_len
    ...
    fn generate_read_lines_advanced(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Store8(MemArg { offset: 1, align: 0, memory_index: 0 }),
            
            Instruction::LocalGet(2), // content_ptr
            Instruction::I32Const(110), // 'n'
            Instruction::I32Store8(MemArg { offset: 2, align: 0, memory_index: 0 }),
            
            Instruction::LocalGet(2), // content_ptr
            Instruction::I32Const(101), // 'e'
            Instruction::I32Store8(MemArg { offset: 3, align: 0, memory_index: 0 }),
            
            Instruction::LocalGet(2), // content_ptr
            Instruction::I32Const(49), // '1'
            Instruction::I32Store8(MemArg { offset: 4, align: 0, memory_index: 0 }),
            
            Instruction::LocalGet(2), // content_ptr
            Instruction::I32Const(10), // '\n'
            Instruction::I32Store8(MemArg { offset: 5, align: 0, memory_index: 0 }),
    ...
    fn generate_read_bytes_advanced(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Add,
            Instruction::LocalGet(2), // content_ptr
            Instruction::I32Load8U(MemArg { offset: 0, align: 0, memory_index: 0 }), // load first byte
            Instruction::I32Store(MemArg { offset: 0, align: 2, memory_index: 0 }), // store as integer
    ...
    fn generate_get_extension_advanced(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::If(BlockType::Empty),
                ...
                Instruction::I32Store8(MemArg { offset: 6, align: 0, memory_index: 0 }),
                
                Instruction::LocalGet(5), // extension result
                Instruction::I32Const(116), // 't'
                Instruction::I32Store8(MemArg { offset: 7, align: 0, memory_index: 0 }),
            Instruction::Else,
                // No extension
                Instruction::LocalGet(5), // extension result
    ...
    fn generate_join_path_advanced(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Const(4), // offset to data
            Instruction::I32Add,
            Instruction::I32Load8U(MemArg { offset: 0, align: 0, memory_index: 0 }), // load first char
            Instruction::I32Store8(MemArg { offset: 0, align: 0, memory_index: 0 }), // store first char
...
mod tests {
    ...
    fn test_read_lines_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Read lines instructions should not be empty");
    }
    ...
    fn test_read_bytes_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Read bytes instructions should not be empty");
    }
    ...
    fn test_size_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Size instructions should not be empty");
    }
    ...
    fn test_is_file_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Is file instructions should not be empty");
    }
    ...
    fn test_get_filename_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Get filename instructions should not be empty");
    }
    ...
    fn test_join_path_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Join path instructions should not be empty");
    }
    ...
    fn test_copy_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Copy instructions should not be empty");
    }
    ...
    fn test_normalize_path_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Normalize path instructions should not be empty");
    }
}