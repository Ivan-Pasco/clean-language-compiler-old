...
impl HttpAdvancedManager {
    ...
    fn register_request_methods(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // response_ptr, url_len, headers_len, status_code, body_ptr
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // response_ptr, url_len, data_len, headers_len, status_code, body_ptr
    ...
    fn register_header_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // header_count, name_len, value_len, entry_ptr, success
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // header_count, current_entry, name_len, found_value, i
    ...
    fn register_response_functions(
        &self,
