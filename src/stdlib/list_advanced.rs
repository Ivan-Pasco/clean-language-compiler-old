    ...
    fn register_map_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // result_list, list_size, i, element, mapped_value, element_ptr
    ...
    fn register_filter_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // result_list, list_size, i, element, predicate_result, filtered_count
    ...
    fn register_reduce_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // accumulator, list_size, i, element, new_accumulator
    ...
    fn register_utility_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // list_size, list_ptr, i, current_value, element_ptr
...
mod tests {
    ...
    fn test_map_advanced_generation() {
        ...
        assert!(
            ...
            "Map instructions should not be empty"
        );
    }
    ...
    fn test_reduce_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "Reduce instructions should not be empty"
        );
    }
    ...
    fn test_foreach_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "ForEach instructions should not be empty"
        );
    }
    ...
    fn test_first_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "First instructions should not be empty"
        );
    }
    ...
    fn test_last_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "Last instructions should not be empty"
        );
    }
    ...
    fn test_fill_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "Fill instructions should not be empty"
        );
    }
    ...
    fn test_range_advanced_generation() {
        ...
        assert!(
            !instructions.is_empty(),
            "Range instructions should not be empty"
        );
    }
}
