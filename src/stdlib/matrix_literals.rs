...
impl MatrixLiteralsManager {
    ...
    fn register_create_integer_matrix(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
    ...
    fn generate_create_integer_matrix(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // load input[i]

            Instruction::I32Store(MemArg { offset: 0, align: 2, memory_index: 0 }), // store to matrix[i]
    ...
    fn register_create_number_matrix(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.createNumber",
            &[WasmType::I32, WasmType::I32, WasmType::I32], // rows, columns, data_array_ptr
    ...
    fn generate_create_number_matrix(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::F64Load(MemArg { offset: 0, align: 3, memory_index: 0 }), // load input[i]

            Instruction::F64Store(MemArg { offset: 0, align: 3, memory_index: 0 }), // store to matrix[i]
    ...
    fn register_create_boolean_matrix(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
    ...
    fn generate_create_boolean_matrix(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load8U(MemArg { offset: 0, align: 0, memory_index: 0 }), // load input[i]

            Instruction::I32Store8(MemArg { offset: 0, align: 0, memory_index: 0 }), // store to matrix[i]
    ...
    fn register_create_string_matrix(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.createString",
            &[WasmType::I32, WasmType::I32, WasmType::I32], // rows, columns, data_array_ptr
    ...
    fn register_get_matrix_element(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.getElement",
    ...
    fn generate_get_matrix_element(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // columns
            Instruction::LocalSet(3), // columns

            // Load element size
            Instruction::LocalGet(0), // matrix_ptr
            Instruction::I32Load(MemArg { offset: 12, align: 2, memory_index: 0 }), // element_size
            ...
            Instruction::Else,
                ...
                Instruction::Else,
                    ...
                    Instruction::LocalGet(6), // data_ptr
                    Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // Load as i32
                Instruction::End,
            Instruction::End,
        ]
    }
    ...
    fn register_set_matrix_element(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.setElement",
    ...
    fn register_get_matrix_row(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // columns, element_size, row_ptr, start_ptr, i
    ...
    fn register_get_matrix_column(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.getColumn",
            &[WasmType::I32, WasmType::I32], // matrix_ptr, column_index
            Some(WasmType::I32), // column array pointer
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // rows, columns, element_size, col_ptr, i, element_ptr
    ...
    fn generate_get_matrix_column(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::LocalGet(0), // matrix_ptr
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // rows
    ...
    fn register_get_matrix_rows(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            vec![
                Instruction::LocalGet(0), // matrix_ptr
                Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // load rows
            ]
        )
    }

    /// Get number of columns in matrix
    fn register_get_matrix_columns(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
            "matrix.getColumns",
            &[WasmType::I32], // matrix_ptr
            ...
            vec![
                Instruction::LocalGet(0), // matrix_ptr
                Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // load columns
            ]
        )
    }
    ...
    fn register_validate_matrix_dimensions(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
    ...
    fn register_matrix_to_string(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            vec![
                ...
                Instruction::LocalGet(0), // matrix_ptr
                Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // load type_id
    ...
    fn register_matrix_equals(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            Some(WasmType::I32), // boolean result
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // rows1, cols1, rows2, cols2, type1, type2
            vec![
