    ...
    fn register_split_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // string_len, delim_len, array_ptr, count, pos, start, match_pos
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // string_len, array_ptr, count, pos, start, char
    ...
    fn register_join_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // total_len, result_ptr, pos, i, part_ptr, part_len
    ...
    fn register_padding_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[
                ...
                WasmType::I32,
                WasmType::I32,
            ], // string_len, pad_len, pad_needed, result_ptr, i, pad_pos
