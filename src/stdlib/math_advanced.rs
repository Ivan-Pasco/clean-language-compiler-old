...
impl MathAdvancedManager {
    ...
    fn register_advanced_trig_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64], // abs_y, abs_x, ratio, result, quadrant_adjustment
    ...
    fn register_advanced_hyperbolic_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_advanced_log_exp_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64], // ln_x, power, term, result, i
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64, WasmType::F64], // ln2_x, power, factorial, term, result
...
mod tests {
    ...
    fn test_atan2_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Atan2 instructions should not be empty");
    }
    ...
    fn test_sinh_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Sinh instructions should not be empty");
    }
    ...
    fn test_cosh_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Cosh instructions should not be empty");
    }
    ...
    fn test_tanh_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Tanh instructions should not be empty");
    }
    ...
    fn test_log2_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Log2 instructions should not be empty");
    }
    ...
    fn test_exp2_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Exp2 instructions should not be empty");
    }
    ...
    fn test_sign_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Sign instructions should not be empty");
    }
    ...
    fn test_clamp_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Clamp instructions should not be empty");
    }
    ...
    fn test_lerp_advanced_generation() {
        ...
        assert!(!instructions.is_empty(), "Lerp instructions should not be empty");
    }
}