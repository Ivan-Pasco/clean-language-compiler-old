...
impl MultilineManager {
    ...
    fn register_expression_helpers(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_chaining_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn get_string_concat_function_index(&self) -> u32 { 500 }
    fn get_combine_integers_function_index(&self) -> u32 { 501 }
    fn get_combine_numbers_function_index(&self) -> u32 { 502 }
}
