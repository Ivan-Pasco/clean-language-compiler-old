...
impl ConsoleInputManager {
    ...
    fn register_basic_input_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_typed_input_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // input_str, parsed_value, is_valid, retry_count, error_message, result
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::F64, WasmType::I32, WasmType::I32, WasmType::I32], // input_str, parsed_value, is_valid, retry_count, error_message
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // input_str, normalized_str, is_valid, result_bool, retry_count, error_message
    ...
    fn register_validation_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // str_len, result, char_code, is_negative, current_pos
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::F64, WasmType::I32, WasmType::I32, WasmType::I32], // str_len, result, char_code, has_dot, current_pos
    ...
    fn register_utility_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
        ...
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // str_len, result_ptr, start_pos, end_pos, char_code
    ...
    fn generate_validate_number(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32GtU, // str_len > 0
            Instruction::If(wasm_encoder::BlockType::Empty),
                Instruction::F64Const(3.14), // Mock parsed value
                Instruction::LocalSet(1), // result
            Instruction::Else,
