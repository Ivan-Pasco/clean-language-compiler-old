...
impl NumericLiteralsManager {
    ...
    fn register_hexadecimal_functions(
        &self,
    ...
    fn register_literal_validation_functions(
        &self,
        codegen: &mut CodeGenerator,
    ) -> Result<(), CompilerError> {
    ...
    fn get_parse_hex_digits_function_index(&self) -> u32 {
        1202
    }
    fn get_parse_hex_digits_64_function_index(&self) -> u32 {
        1203
    }
    fn get_validate_hex_digits_function_index(&self) -> u32 {
        1204
    }
    fn get_hex_zero_string_function_index(&self) -> u32 {
        1205
    }
    fn get_convert_to_hex_string_function_index(&self) -> u32 {
        1206
    }
    fn get_parse_binary_digits_function_index(&self) -> u32 {
        1207
    }
    fn get_parse_binary_digits_64_function_index(&self) -> u32 {
        1208
    }
    fn get_validate_binary_digits_function_index(&self) -> u32 {
        1209
    }
    fn get_binary_zero_string_function_index(&self) -> u32 {
        1210
    }
    fn get_convert_to_binary_string_function_index(&self) -> u32 {
        1211
    }
    fn get_parse_octal_digits_function_index(&self) -> u32 {
        1212
    }
    fn get_parse_octal_digits_64_function_index(&self) -> u32 {
        1213
    }
    fn get_validate_octal_digits_function_index(&self) -> u32 {
        1214
    }
    fn get_octal_zero_string_function_index(&self) -> u32 {
        1215
    }
    fn get_convert_to_octal_string_function_index(&self) -> u32 {
        1216
    }
    fn get_detect_literal_type_function_index(&self) -> u32 {
        1217
    }
    fn get_parse_hex_integer_function_index(&self) -> u32 {
        1218
    }
    fn get_parse_binary_integer_function_index(&self) -> u32 {
        1219
    }
    fn get_parse_octal_integer_function_index(&self) -> u32 {
        1220
    }
    fn get_parse_decimal_integer_function_index(&self) -> u32 {
        1221
    }
    fn get_parse_hex_integer_64_function_index(&self) -> u32 {
        1222
    }
    fn get_parse_binary_integer_64_function_index(&self) -> u32 {
        1223
    }
    fn get_parse_octal_integer_64_function_index(&self) -> u32 {
        1224
    }
    fn get_parse_decimal_integer_64_function_index(&self) -> u32 {
        1225
    }
    fn get_validate_hex_function_index(&self) -> u32 {
        1226
    }
    fn get_validate_binary_function_index(&self) -> u32 {
        1227
    }
    fn get_validate_octal_function_index(&self) -> u32 {
        1228
    }
    fn get_validate_decimal_function_index(&self) -> u32 {
        1229
    }
}
...
mod tests {
    ...
    fn test_numeric_literals_manager_creation() {
        ...
        assert_eq!(literals_manager.memory_manager.borrow().get_total_allocated(), 0);
    }
    ...
    fn test_binary_functions_generation() {
        ...
        assert!(validate_binary
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(48)))); // '0'
        assert!(validate_binary
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(98)))); // 'b'
        ...
        assert!(to_binary
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Eqz)));
    }
    ...
    fn test_literal_detection_generation() {
        ...
        assert!(detect_type
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(120)))); // 'x'
        assert!(detect_type
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(98)))); // 'b'
        assert!(detect_type
        ...
        assert!(get_base
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(8))));
        assert!(get_base
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(10))));
        assert!(get_base
            .iter()
            .any(|inst| matches!(inst, Instruction::I32Const(16))));
    }
    ...
    fn test_64_bit_parsing_generation() {
        ...
        let has_i64_result = parse_any_64
            .iter()
            .any(|inst| matches!(inst, Instruction::If(BlockType::Result(ValType::I64))));
        assert!(
            has_i64_result,
            "Should contain If blocks that return I64 values"
        );

        // Should contain calls to 64-bit parsing functions
        let call_count = parse_any_64
            .iter()
