...
impl StringInterpolationManager {
    ...
    fn register_interpolation_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn register_formatting_functions(&self, codegen: &mut CodeGenerator) -> Result<(), CompilerError> {
    ...
    fn generate_interpolate_multiple(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // Load array size
    ...
    fn get_create_builder_function_index(&self) -> u32 { 900 }
    fn get_string_find_char_function_index(&self) -> u32 { 901 }
    fn get_string_find_char_from_function_index(&self) -> u32 { 902 }
    fn get_builder_append_substring_function_index(&self) -> u32 { 903 }
    fn get_builder_append_value_function_index(&self) -> u32 { 904 }
    fn get_builder_finalize_function_index(&self) -> u32 { 905 }
    fn get_process_multiple_placeholders_function_index(&self) -> u32 { 906 }
    fn get_count_placeholders_function_index(&self) -> u32 { 907 }
    fn get_allocate_function_index(&self) -> u32 { 908 }
    fn get_parse_placeholder_positions_function_index(&self) -> u32 { 909 }
    fn get_extract_brace_expressions_function_index(&self) -> u32 { 910 }
    fn get_integer_to_string_function_index(&self) -> u32 { 911 }
    fn get_string_pad_function_index(&self) -> u32 { 912 }
    fn get_number_to_string_precision_function_index(&self) -> u32 { 913 }
    fn get_value_to_string_function_index(&self) -> u32 { 914 }
    fn get_string_length_function_index(&self) -> u32 { 915 }
    fn get_builder_grow_function_index(&self) -> u32 { 916 }
    fn get_string_data_ptr_function_index(&self) -> u32 { 917 }
    fn get_memory_copy_function_index(&self) -> u32 { 918 }
    fn get_builder_append_function_index(&self) -> u32 { 919 }
    fn get_format_value_function_index(&self) -> u32 { 920 }
    fn get_format_integer_function_index(&self) -> u32 { 921 }
    fn get_format_number_function_index(&self) -> u32 { 922 }
}
...
mod tests {
    ...
    fn test_string_builder_generation() {
        ...
        let has_if = append_builder.iter().any(|inst| matches!(inst, Instruction::If(_)));
        assert!(has_if, "Builder append should contain If instruction for growth check");
