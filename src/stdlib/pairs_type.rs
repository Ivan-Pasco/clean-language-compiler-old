...
impl PairsTypeManager {
    ...
    fn register_create_pairs_with_capacity(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            codegen,
    ...
    fn register_pairs_set(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            None, // void
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // size, capacity, entries_ptr, hash, index, entry_ptr
    ...
    fn generate_pairs_set(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::LocalGet(0), // pairs_ptr
            Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // capacity
            Instruction::LocalSet(4), // capacity

            Instruction::LocalGet(0), // pairs_ptr
            Instruction::I32Load(MemArg { offset: 16, align: 2, memory_index: 0 }), // entries_ptr
            ...
            Instruction::LocalGet(1), // key_ptr
            Instruction::I32Store(MemArg { offset: 0, align: 2, memory_index: 0 }), // store key

            Instruction::LocalGet(8), // entry_ptr
            Instruction::LocalGet(2), // value_ptr
            Instruction::I32Store(MemArg { offset: 8, align: 2, memory_index: 0 }), // store value
    ...
    fn register_pairs_get(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // capacity, entries_ptr, hash, entry_ptr, stored_key
    ...
    fn generate_pairs_get(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // stored_key
            ...
            Instruction::If(BlockType::Result(ValType::I32)),
                ...
                Instruction::LocalGet(5), // entry_ptr
                Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // load value
            Instruction::Else,
    ...
    fn register_pairs_remove(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // size, capacity, entries_ptr, hash, entry_ptr, stored_key
    ...
    fn generate_pairs_remove(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::If(BlockType::Result(ValType::I32)),
                ...
                Instruction::I32Store(MemArg { offset: 0, align: 2, memory_index: 0 }), // clear key

                Instruction::LocalGet(6), // entry_ptr
                Instruction::I32Const(0), // null value
                Instruction::I32Store(MemArg { offset: 8, align: 2, memory_index: 0 }), // clear value
    ...
    fn register_pairs_capacity(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            vec![
                Instruction::LocalGet(0), // pairs_ptr
                Instruction::I32Load(MemArg { offset: 4, align: 2, memory_index: 0 }), // load capacity
            ]
        )
    }
    ...
    fn register_pairs_keys(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // size, capacity, entries_ptr, keys_ptr, i, j, entry_ptr
    ...
    fn generate_pairs_keys(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // load key
            Instruction::I32Const(0),
    ...
    fn register_pairs_values(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // size, capacity, entries_ptr, values_ptr, i, j, entry_ptr
    ...
    fn generate_pairs_values(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::If(BlockType::Empty),
                ...
                Instruction::LocalGet(7), // entry_ptr
                Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // load value
                Instruction::I32Store(MemArg { offset: 0, align: 2, memory_index: 0 }), // store value
    ...
    fn register_pairs_entries(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            &[WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32, WasmType::I32], // size, capacity, src_entries_ptr, dest_entries_ptr, i, j, entry_ptr
    ...
    fn generate_pairs_entries(&self) -> Vec<Instruction> {
        vec![
            ...
            Instruction::If(BlockType::Empty),
                ...
                Instruction::LocalGet(7), // entry_ptr
                Instruction::I32Load(MemArg { offset: 8, align: 2, memory_index: 0 }), // load value
                Instruction::I32Store(MemArg { offset: 4, align: 2, memory_index: 0 }), // store value
    ...
    fn register_pairs_equals(&self, codegen: &mut CodeGenerator) -> Result<u32, CompilerError> {
        register_stdlib_function_with_locals(
            ...
            vec![
                ...
                Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // size1
                Instruction::LocalSet(2), // size1

                Instruction::LocalGet(1), // pairs2_ptr
                Instruction::I32Load(MemArg { offset: 0, align: 2, memory_index: 0 }), // size2
